...
import 'package:careme24/core/utils/color_constant.dart';
...
class _VoiceMessageState extends State<VoiceMessage>
  ...
  Container _sizerChild(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      border: Border.all(
        color:widget.me? Colors.blue : Colors.grey,
        width: 1,
      ),
  ...
  Widget _playButton(BuildContext context) => InkWell(
    child: Container(
      decoration: BoxDecoration(
        ...
        color: widget.me ? widget.meFgColor :Colors.blue.shade300,
      ),
      width: 10.w,
      height: 10.w,
      child: InkWell(
