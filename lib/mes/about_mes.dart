...
class AboutMES extends StatefulWidget {
  @override
  State<AboutMES> createState() => _AboutMESState();
}

class _AboutMESState extends State<AboutMES> {
    ...
    return SafeArea(
        child: Scaffold(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: Text(
                                    "Пожарная Часть N 1 Гпс МЧС России ПО Новосибирской Обл.",
                                    maxLines: null,
                            ...
                            Padding(
                                ...
                                child: Text("Красный пр-т., 36, Новосибирск, Новосибирская обл",
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text("8 (383) 222-39-73", style: AppStyle.txtMontserratMedium15Black900,),
                                          ),
                                          CustomImageView(
          ...
          bottomNavigationBar: GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => QualityControl()));
            },
            child: Container(
              width: 1,
              height: 100,
